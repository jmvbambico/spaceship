<section id="intro" class="intro">
    ...
    <div class="slogan">
      ...
      <h4>WE ARE A GROUP OF GENTLEMEN MAKING AWESOME WEB WITH BOOTSTRAP</h4>
    </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="description" rows="5" data-rule="required" data-msg="Please tell us more about yourself" placeholder="Description"></textarea>
                    <div class="validation"></div>
                  </div>
                </div>
                <div class="col-md-12">
